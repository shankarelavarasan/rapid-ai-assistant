...
const ModernUIDemo = () => {
    ...
    const handlePresetChange = (presetName) => {
        ...
        const preset = cursorPresets[presetName];
        if (preset) {
            updateConfig(preset);
        }
    };
        ...
        <div className="pt-20">
            ...
            <div className="max-w-6xl mx-auto w-full">
              ...
              <ScrollReveal direction="up" delay={0.4}>
                <GlassCard className="p-8">
                  <ImageSlider images={sliderImages} autoPlay={true} interval={5000} className="w-full"/>
                </GlassCard>
              </ScrollReveal>
            </div>
          </section>
          ...
          <section id="carousel" className="min-h-screen flex items-center justify-center px-6 py-20">
            <div className="max-w-6xl mx-auto w-full">
              ...
              <ScrollReveal direction="up" delay={0.4}>
                <GlassCard className="p-8">
                  <Carousel3D items={carouselItems} autoRotate={true} rotationSpeed={4000}/>
                </GlassCard>
              </ScrollReveal>
            </div>
          </section>
              ...
              <ScrollReveal direction="up" delay={0.4}>
                <GlassCard className="p-8">
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                    {Object.keys(cursorPresets).map((presetName) => (<GlassButton key={presetName} variant={selectedPreset === presetName ? 'primary' : 'secondary'} onClick={() => handlePresetChange(presetName)} className="capitalize">
                        {presetName}
                      </GlassButton>))}
                  </div>
...
//# sourceMappingURL=ModernUIDemo.js.map