  ...
  return (
    <div className={`relative w-full h-96 overflow-hidden ${className}`}>
      ...
      >
        ...
        <div
          ref={carouselRef}
          className="relative w-64 h-64 transition-transform duration-700 ease-out cursor-grab active:cursor-grabbing"
          style={{
        ...
        >
          {items.map((item, index) => {
            ...
            return (
              <div
                key={item.id}
                className={`absolute w-full h-full rounded-xl overflow-hidden shadow-2xl transition-all duration-500 ${
              ...
              >
                ...
                <div className="relative w-full h-full bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 rounded-xl overflow-hidden group hover:scale-105 transition-transform duration-300">
                  ...
                  {/* Active Indicator */}
                  {isActive && (
                    <div className="absolute top-4 right-4 w-3 h-3 bg-yellow-400 rounded-full animate-pulse shadow-lg" />
                  )}
      ...
      <div className="absolute top-1/2 left-4 -translate-y-1/2">
        <button
          ...
          className="bg-white/20 backdrop-blur-md hover:bg-white/30 text-white p-3 rounded-full transition-all duration-300 hover:scale-110 group"
