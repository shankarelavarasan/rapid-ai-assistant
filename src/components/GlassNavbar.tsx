        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              {logo ? (
                <img src={logo} alt={logoText} className="h-8 w-8 rounded-lg" />
              ) : (
            ...
            <div className="hidden md:flex items-center space-x-1">
              {items.map((item) => (
                ...
                >
                  ...
                  {/* Active indicator */}
                  {activeItem === item.id && (
                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1 h-1 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full" />
                  )}
                </button>
              ))}
            </div>
            ...
            <div className="flex items-center space-x-3">
                ...
                {showSearch ? (
                  <div className="flex items-center space-x-2 bg-white/10 backdrop-blur-md rounded-xl px-3 py-2 border border-white/20">
                    ...
                    <input
                      ...
                      placeholder="Search..."
                      className="bg-transparent text-white placeholder-white/60 outline-none w-32 sm:w-48"
                      onBlur={() => {
                        if (!searchQuery) {
                          setShowSearch(false);
                        }
              ...
              <button
                ...
                className="md:hidden p-2 rounded-xl bg-white/10 hover:bg-white/20 text-white transition-all duration-300"
              >
